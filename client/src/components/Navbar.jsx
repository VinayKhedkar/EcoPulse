...
const Navbar = () => {
  ...
  return (
    <div className="max-container relative z-10 bottom-[1rem] bg-transparent rounded-full">
          ...
          >
            ...
            >
              <path
                ...
                stroke={isActive("/social") ? "#007e2f" : "#939393"}
          ...
          >
            ...
            >
              <path
                ...
                stroke={isActive("/shop") ? "#007e2f" : "#939393"}
          ...
          >
            ...
            >
              <path
                ...
                stroke={isActive("/profile") ? "#007e2f" : "#939393"}
